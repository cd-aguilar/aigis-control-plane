...
> Status: Phase 0/1 done -- domain layer (TaskContract, ToolRequest,
> PolicyDecision, Attempt, TaskState, GateResult, Evidence, Decision) as
> Pydantic models, 47 unit tests green, ruff clean. Agent Runtime, Policy
> Engine, Sandbox and Quality Gates not implemented yet. See
> `docs/ARCHITECTURE.md` for the full spec, phased roadmap, and current state.
