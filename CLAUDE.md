...
Sin implementar aun: Security Evaluation Suite (Fase 5), integración end-to-end / CLI real (Fase 6).
...
- [x] Fase 4: Quality Gates ejecutables (pytest/ruff dentro del Sandbox,
      ...
      agente)
- [ ] Fase 5: Security Evaluation Suite (prompt injection, secret access,
      path traversal, command injection, resource exhaustion)
