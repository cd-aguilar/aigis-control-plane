...
Sin implementar aun: S03-S05 (path traversal, command injection, resource exhaustion — diferidas, timing a decidir), Fase 7 (Production Hardening, fuera del alcance inicial).
...
- [ ] Decidir timing de S03/S04/S05 (path traversal, command injection,
      resource exhaustion) — diferidas desde Fase 5, no rechazadas
