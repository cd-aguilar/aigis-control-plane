...
- Estado de tests verificado el 2026-08-27: **196 tests pasando, 1 skip condicional al entorno**, `ruff check` limpio.

**Pendiente:**
- Fase 6: correr T02-T08 en vivo contra la API real (solo T01 confirmado hasta ahora), y agregación de métricas de la sección 19 (requiere varias corridas reales para tener datos que agregar).
